...
**Status:** 1.11.1 — Control Plane P9 v1 publicado e validado em `robot.fracta.online`, com login, lifecycle, OMS ops, catálogo, auditoria e interface alinhada ao design system GoldenLens. Próximo gate: campanha shadow supervisionada.
