...
export const MIDAS_V1 = {
  ...
  // cushionDecay / oddsVelGate — OFF no núcleo; ON em btc-gold-cushion-v1 (lab)
  cushionDecayEnabled: false,
  cushionDecayStartSec: 20,
  cushionDecayEndSec: 4,
  cushionDecayMinDist: 0.0,
  cushionDecayMinBidRatio: 0.55,
  oddsVelGateEnabled: false,
  oddsVelLookbackSec: 2,
  oddsVelMaxDelta: 0.12,
  oddsVelCondMode: 0,
  oddsVelCondAskMax: 0.0,
  oddsVelCondDistMin: 0.0,
  oddsVelCondMinSecs: 0.0,
  oddsVelBlockOnHit: true,
  oddsVelSizeFactor: 1.0,
...
/**
 * MIDAS-GOLD lab (g3-os): sizing $10/$30.
 * Paridade Estúdio v11+; não é o default live com banca $150.
