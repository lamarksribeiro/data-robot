        ...
        versions: [
          {
            ...
            presets: [
              ...
              midasPreset('btc-gold-v1', {
                name: 'BTC Portfolio ($2.5–$4 · tier 1.5×) · 5 ativos · FAK/GTC',
                role: 'champion',
                source: 'runtime',
              ...
              midasPreset('eth-gold-v1', {
                name: 'ETH Portfolio ($2.5–$4 · tier 1.5×) · 5 ativos · FAK/GTC',
                role: 'candidate',
                source: 'runtime',
                params: { ...midasPortfolioPreset() },
                editableKeys: EDITABLE_MIDAS,
              ...
              midasPreset('sol-gold-v1', {
                name: 'SOL Portfolio ($2.5–$4 · tier 1.5×) · 5 ativos · FAK/GTC',
                role: 'candidate',
                source: 'runtime',
                params: { ...midasPortfolioPreset() },
                editableKeys: EDITABLE_MIDAS,
              ...
              midasPreset('xrp-gold-v1', {
                name: 'XRP Portfolio ($2.5–$4 · tier 1.5×) · 5 ativos · FAK/GTC',
                role: 'candidate',
                source: 'runtime',
                params: { ...midasPortfolioPreset() },
                editableKeys: EDITABLE_MIDAS,
              }),
              midasPreset('doge-gold-v1', {
                name: 'DOGE Portfolio ($2.5–$4 · tier 1.5×) · 5 ativos · FAK/GTC',
                role: 'candidate',
                source: 'runtime',
                params: { ...midasPortfolioPreset() },
                editableKeys: EDITABLE_MIDAS,
